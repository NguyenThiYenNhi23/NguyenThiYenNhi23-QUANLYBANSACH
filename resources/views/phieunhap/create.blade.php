            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    >
                        ...
                        @foreach($nhanViens as $nhanVien)
                            ...
                            <option
                                value="{{ $nhanVien->maNV }}"
                                {{ old('maNV') == $nhanVien->maNV ? 'selected' : '' }}
                            >
                                {{ $nhanVien->hoTen }}
                            </option>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        name="ngayNhap"
                        class="form-control"
                        value="{{ old('ngayNhap', now()->format('Y-m-d\TH:i')) }}"
                        required
                    >
...
function addRow() {
    ...
    newRow.querySelector('.thanh-tien').textContent = '0';
...
function removeRow(button) {
    ...
    if (rows.length === 1) {
        ...
        alert('Phiếu nhập phải có ít nhất một sách.');
