...
<div class="form-card">
    ...
    <form
        action="{{ route('sach.update', $sach->maSach) }}"
        method="POST"
                ...
                >
                    ...
                    @foreach($danhMucs as $danhMuc)
                        ...
                        <option
                            ...
                            {{ old('maDanhMuc', $sach->maDanhMuc) == $danhMuc->maDanhMuc ? 'selected' : '' }}
                        >
                            {{ $danhMuc->tenDanhMuc }}
                        </option>
            ...
            <div class="form-group">
                ...
                >
                    ...
                    <option
                        ...
                        {{ old('trangThai', $sach->trangThai) == 'Đang kinh doanh' ? 'selected' : '' }}
                    >
                        Đang kinh doanh
                    </option>
                    ...
                    <option
                        ...
                        {{ old('trangThai', $sach->trangThai) == 'Ngừng kinh doanh' ? 'selected' : '' }}
                    >
                        Ngừng kinh doanh
                    </option>
            ...
            <div class="form-group full">
                ...
                <div class="upload-box">
                    ...
                    <div class="helper-text">
                        Bạn có thể thay ảnh mới hoặc giữ nguyên ảnh hiện tại.
